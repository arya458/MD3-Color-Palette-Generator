...
export function showToast(toastElement, msg) {
    toastElement.textContent = msg;
    toastElement.classList.add('show');
    setTimeout(() => toastElement.classList.remove('show'), 3000);
}
export function handleExportJson(palette, toastElement) {
...
export function handleExportKt(palette, toastElement) {
...
export function handleExportJs(palette, toastElement) {
    const content = `
...
export function handleExportTs(palette, toastElement) {
    const content = `
...
export function handleExportLaravel(palette, toastElement) {
    const content = `<?php
return [
    'light' => [
        'primary' => '${palette.light.primary}',
...
export function handleExportReact(palette, toastElement) {
    const content = `
export const lightColors = {
  primary: "${palette.light.primary}",
  onPrimary: "${palette.light.onPrimary}",
...
;
export function handleExportBlazor(palette, toastElement) {
    const formatColor = (hex) => hex.toUpperCase();
    const content = `
